...
public final class Constants {
    ...
    public static final String FIREBASE_FRIEND_OF_LOCATION = BuildConfig.FIREBASE_FRIEND_OF_LOCATION;
    public static final String PROPERTY_USER_NAME = BuildConfig.PROPERTY_USER_NAME;
